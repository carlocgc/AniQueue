...
namespace AniQueue.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260820220856_ScoringReturnLimit")]
    partial class ScoringReturnLimit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AniQueue.Core.Domain.ProfileSettings", b =>
                {
                    ...
                    b.Property<int?>("RecommendationCandidateLimit")
                        .HasColumnType("INTEGER");

                    b.Property<int>("RecommendationHistorySize")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("RecommendationReturnTop")
                        .HasColumnType("INTEGER");
